  ...
  class Samples < Hashie::Mash
    ...
    def to_solr
      ...
      solr = {
        ...
        :name              => doc.fetch("name", ""),
        #:latitude   => doc.fetch("latitude", -90),
        #:longitude  => doc.fetch("longitude", -180),
        :latitude_start    => doc.fetch("latitude_start", -90),
        :longitude_start   => doc.fetch("longitude_start", -180),
        #:latitude_end      => doc.fetch("latitude_end_dec", -360),
        #:longitude_end     => doc.fetch("longitude_end_dec", -360),
